...
// PA5 connected to column 0 (keypad pin 1) using 1K pull-up
// PA4 connected to column 1 (keypad pin 2) using 1K pull-up
// PA3 connected to column 2 (keypad pin 3) using 1K pull-up
// PA2 connected to column 3 (keypad pin 4) using 1K pull-up
// PD3 connected to row 0 (keypad pin 5)
// PD2 connected to row 1 (keypad pin 6)
// PD1 connected to row 2 (keypad pin 7) (remove R9, R10)
// PD0 connected to row 3 (keypad pin 8) (remove R9, R10)
...
void SysTick_Initialize(uint32_t period){
...
void Matrix_Init(void){
  ...
  SysTick_Initialize(400000);  // Program 5.12, 25 ms polling
} 
